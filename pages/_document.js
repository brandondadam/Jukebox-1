...
export default class IntlDocument extends Document {
  ...
  render() {
    return (
      <html>
        <Head>
          <title>Jukebox - 1</title>
          <meta
            name="description"
            content="A collaborative queue where you propose and vote what's going to play next. Use your Spotify account to login"
          />
          <link rel="shortcut icon" href="/static/logo-128.png" />
